<?php /* Template Name: Page Les Régions */
...
<main id="primary" class="site-main">
    <div class="carte-des-regions">
        <?php require_once(get_template_directory() . '/assets/svg/carte-france.php'); ?>
    </div>
    <?php require_once(get_template_directory() . '/inc/inc-children-pages.php'); ?>
</main><!-- #main -->
